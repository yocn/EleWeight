...
import com.bjw.ComAssistant.activity.DetailListActivity;
...
public class BluetoothService {
    ...
    private void connectionFailed() {
        ...
        Bundle bundle = new Bundle();
        bundle.putString(TOAST, "连接未成功，请重新连接");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(TOAST, "连接断开，请重新连接");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private class ConnectThread extends Thread {
        ...
        public void run() {
            ...
            // Always cancel discovery because it will slow down a connection(开始连接之前必须停止搜索设备)
